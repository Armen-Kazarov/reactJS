        ...
        return (
            <div>
                ...
                <div style={{display: isOpen}} className="sidemenu">
                     <FontAwesome className="super-crazy-colors" name='times' size="2" spin style={{ color: 'white', textShadow: '0 1px 0 rgba(0, 0, 0, 0.1)' }}/>
                    <ul>
                        <li data-id="0" onClick={() => this.changeContent(1)}>ChangeBackground</li>
